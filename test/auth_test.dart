...
void main() {
  group('Mock Authentication', () {
    ...
    test('User should be null at initialization', () {
    ...
    test('Create user should delegate to logIn function', () async {
      ...
      final badPasswordUser =
          provider.createUser(email: 'newmail@bar.com', password: 'foobar');
      expect(
        badPasswordUser,
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({
    ...
    const user = AuthUser(isEmailVerified: false, email: 'new@email.com');
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(isEmailVerified: true, email: 'new@email.com');
    _user = newUser;
  }
}
